...
Set the 'experimentType' variable within the script to 1, 2, 3 or 4 to run specific simulations:
...
*  experimentType = 4: Runs compare_Sq(); This plots |S_{q_s}| using K-BEKEM$q_s$ 
